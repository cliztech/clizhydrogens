        ...
        <div className="bestseller-grid">
          {featured ? (
            <Link className="bestseller-spotlight" prefetch="intent" to={handle}>
              <div className="bestseller-spotlight__media" aria-hidden="true">
  ...
  return (
    <section className="homepage-section studio-section">
      <div className="page-width studio-grid">
        <div className="studio-media" aria-hidden="true">
          <img
...
function getCollectionExcerpt(description) {
  if (!description) {
    return 'Discover a fresh palette of cheeky statements and colour-forward pairings.';
  }
  ...
  if (textContent.length <= 140) return textContent;
  return `${textContent.slice(0, 137).trim()}…`;
}
